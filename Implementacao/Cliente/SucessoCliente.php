	...
	<section class="tudo">
		<div class="quadro">
			...
			<div class="alinhaSucesso">
				<div class="linha">
					<div class="esquerdo"><div>Nome Completo:</div></div>
					<div class="meio"><div><?php echo $model->getNomeCompleto();?></div></div>
				</div>
				<div class="linha">
				...
				<div class="linha">
					...
					<div class="meio"><div><?php echo $model->getCpf().$model->getCnpj();?></div></div>
				</div>
				<div class="linha">
				...
				<div class="linhaBotao">
					<div class="embaixoBotoes">
						<?php
							if (!$erro) {
								echo '<a href="ControllerCliente.php?acao=editar&id='.$model->getId().'"><div class="botSucesso">Alterar</div></a>';
							}
						?>
						<a href="ControllerCliente.php?acao=abrirCadastro"><div class="botSucesso">Cadastrar Novo</div></a>
					</div>
				</div>
			</div>
		</div>
